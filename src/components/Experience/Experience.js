...
function Experience() {
	return (
		<section id="experience">
			<h1>Experience</h1>
			<div
				id="experience5-container"
				className="experience"
				data-aos="fade-right"
			>
				<img
					id="equitable"
					alt="The Equitable Life Insurance Company of Canada Logo"
					src={equitableImage}
				></img>
				<div className="text-content">
					...
					<p>
						<b>Languages and Tools:</b> SQL, .NET, C#, React.
					</p>
				</div>
			</div>
			<br></br>
			<div
				id="experience4-container"
				className="experience"
				data-aos="fade-left"
			>
				<img
					id="prs2"
					alt="University of Waterloo's Print + Retail Solutions Logo"
					src={prsImage}
				></img>
				<div className="text-content">
					<h2 className="job-title">
					...
					<p className="location">
						University of Waterloo's Print + Retail Solutions,
						Waterloo, ON
					</p>
					<p>
						<b>Languages and Tools:</b> UniVerse BASIC, PHP, HTML,
						Javascript, Node.js, Docker, MySQL.
					</p>
				</div>
			</div>
			<br></br>
			<div
				id="experience3-container"
				className="experience"
				data-aos="fade-right"
			>
				<img
			...
			<br></br>
			<div
				id="experience2-container"
				className="experience"
				data-aos="fade-left"
			>
				<img
					id="warriors"
					alt="Waterloo Warriors Logo"
					src={warriorsImage}
				></img>
				<div className="text-content">
					<h2 className="job-title">
					...
					<p className="location">
						University of Waterloo Varsity Football, Waterloo, ON
					</p>
					<p>
						Received University of Waterloo Varsity Football
			...
			<br></br>
			<div
				id="experience1-container"
				className="experience"
				data-aos="fade-right"
			>
				<img
					id="svpteens"
					alt="Social Venture Partners Teens Logo"
					src={svpImage}
				></img>
				<div className="text-content">
					<h2 className="job-title">
					...
					<p className="location">
						Social Venture Partners Teens, Waterloo, ON
					</p>
					<p>
						Contributed to raising nearly $4000 presented to the
						Bereaved Families of Ontario in 2021, and nearly $5000
						to Martin Luther University College in 2022.
					</p>
				</div>
			</div>
			<br></br>
