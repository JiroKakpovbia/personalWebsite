			...
			<div id="skills-container">
				...
				<div id="languages" className="skills" data-aos="fade-in" data-aos-delay="0">
					...
					<a
						...
						data-aos-delay="150"
					>
						<img alt="C# Logo" src="https://upload.wikimedia.org/wikipedia/commons/d/d2/C_Sharp_Logo_2023.svg" />
						<span className="display-text">C#</span>
					</a>
					...
					<a href="https://graphql.org/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="650">
						<img
							alt="GraphQL logo"
							src="https://graphqleditorcms.fra1.cdn.digitaloceanspaces.com/graphqleditorcms/graphql_page/graphql-1732132118455.png"
						/>
				...
				<div id="frameworks" className="skills" data-aos="fade-in" data-aos-delay="0">
					...
					<a href="https://nextjs.org/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="100">
						<img alt="Next.js Logo" src="https://www.svgrepo.com/show/354113/nextjs-icon.svg" />
				...
				<div id="libraries" className="skills" data-aos="fade-in" data-aos-delay="0">
					...
					<a href="https://redux.js.org/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="100">
						<img alt="Redux Logo" src="https://github.com/reduxjs.png" />
					...
					<a href="https://pytorch.org/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="200">
						<img alt="PyTorch Logo" src="https://blog.christianperone.com/wp-content/uploads/2018/10/pytorch-logo.png" />
					...
					<a href="https://numpy.org/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="250">
						<img alt="NumPy Logo" src="https://cdn.worldvectorlogo.com/logos/numpy-1.svg" />
					...
					<a href="https://michalsnik.github.io/aos/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="350">
						<img alt="AOS Logo" src="https://www.drupal.org/files/project-images/Drupal-AOSJS-Animate-On-Scroll-Javascript-Library.png" />
					...
					<a href="https://opencv.org/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="400">
						<img alt="OpenCV Logo" src="https://opencv24-python-tutorials.readthedocs.io/en/latest/_static/opencv-logo-white.png" />
					...
					<a href="https://mui.com/material-ui/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="450">
						<img alt="Material UI Logo" src="https://www.remoterocketship.com/images/blog/Material%20UI-icon-for-blog.jpg" />
				...
				<div id="developer-tools" className="skills" data-aos="fade-in" data-aos-delay="0">
					...
					<a href="https://kubernetes.io/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="150">
						<img alt="Kubernetes logo" src="https://cdn.geekwire.com/wp-content/uploads/2017/09/favicon.png" />
					...
					>
						<img
							alt="Bash logo"
							src="https://dlab.berkeley.edu/sites/default/files/styles/openberkeley_brand_widgets_rectangle/public/bash.png?itok=OXn82XHK&timestamp=1632296342"
						/>
					...
					<a href="https://swagger.io/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="450">
						<img alt="Swagger logo" src="https://upload.wikimedia.org/wikipedia/commons/a/ab/Swagger-logo.png" />
					...
					<a
						...
						data-aos-delay="550"
					>
						<img alt="VS Code logo" src="https://chris-ayers.com/assets/images/vscode-logo.png" />
					...
					<a href="https://developer.apple.com/xcode/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="600">
						<img
							alt="xCode logo"
							src="https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/67/c9/6c/67c96c86-06f3-1da3-5127-b29ca02c23e9/Xcode-85-220-0-4-0-0-2x-sRGB-0-0.png/1200x630bb.png"
						/>
					...
					<a href="https://storybook.js.org/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="700">
						<img alt="Storybook logo" src="https://pbs.twimg.com/profile_images/1100804485616566273/sOct-Txm_400x400.png" />
					...
					<a
						...
						data-aos-delay="850"
					>
						<img alt="SSH logo" src="https://miro.medium.com/v2/resize:fit:512/1*8ebQwZcMBgsZ6prLW8p-HA.png" />
					...
					<a
						...
						data-aos-delay="900"
					>
						<img alt="RDP logo" src="https://rangee.com/wp-content/uploads/2024/10/unnamed.png" />
					...
					<a href="https://copilot.microsoft.com/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="950">
						<img
							alt="Copilot logo"
							src="https://upload.wikimedia.org/wikipedia/en/thumb/a/aa/Microsoft_Copilot_Icon.svg/1200px-Microsoft_Copilot_Icon.svg.png"
						/>
					...
					<a href="https://xunit.net/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="1050">
						<img alt="xUnit logo" src="https://avatars.githubusercontent.com/u/2092016?s=280&v=4" />
					...
					<a href="https://jestjs.io/" target="_blank" rel="noopener noreferrer" data-aos="fade-left" data-aos-delay="1100">
						<img alt="Jest logo" src="https://www.vikingsoftware.com/wp-content/uploads/2024/02/Jest.png" />
					...
					<a
						...
						data-aos-delay="1150"
					>
						<img alt="GitHub Actions logo" src="https://miro.medium.com/v2/resize:fit:1400/1*7qk0-4XwCKWQO0GU5Hu39w.png" />
					...
					>
						<img
							...
							src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Microsoft_365_%282022%29.svg/931px-Microsoft_365_%282022%29.svg.png"
						/>
					...
					<a
						...
						data-aos-delay="1350"
					>
						<img alt="Jira logo" src="https://www.pillar.vc/playlist/wp-content/uploads/sites/3/2021/03/jira-1.svg" />
