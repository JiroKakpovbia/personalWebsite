        ...
        <section id="experience">
            ...
            <div id="experience1-container" className="experience" data-aos="fade-left">
                ...
                <div className="text-content">
                    ...
                    <p><b>Languages and Tools:</b> UniVerse BASIC, PHP, HTML, Javascript, Node.js, Docker, MySQL.</p>
                </div>
            </div>
            <br></br>
            <div id="experience2-container" className="experience" data-aos="fade-right">
                ...
                <div className="text-content">
                    ...
                    <p className="location">University of Waterloo's Print + Retail Solutions, Waterloo, ON</p>
                    <p><b>Languages and Tools:</b> UniVerse BASIC, PHP, HTML, Javascript, SQL.</p>
                </div>
            </div>
            {/* <br></br>
            ...
            <div id="experience4-container" className="experience" data-aos="fade-right">
                ...
                <div className="text-content">
                    ...
                    <p>Contributed to raising nearly $4000 presented to the Bereaved Families of Ontario in 2021, and nearly $5000 to Martin Luther University College in 2022.</p>
                </div>
            </div>
            <br></br>
        </section>
